                        ...
                        <div class="grid columns-12 gap-6">
                            ...
                            <div class="g-col-12 mt-8">
                                <div class="intro-y d-flex align-items-center h-10">
                                    ...
                                    <a href="index.html" class="ms-auto d-flex align-items-center text-theme-1 dark-text-theme-10"> <i data-feather="refresh-ccw" class="w-4 h-4 me-3"></i> Reload Data </a>
                                </div>
                            ...
                            <div class="g-col-12 g-col-lg-6 mt-8">
                                ...
                                <div class="intro-y box p-5 mt-12 mt-sm-5">
                                    <div class="d-flex flex-column flex-xl-row align-items-xl-center">
                                        <div class="d-flex">
                                            <div>
                                                <div class="text-theme-19 dark-text-gray-300 fs-lg fs-xl-xl fw-medium">$15,000</div>
                                                <div class="mt-0.5 text-gray-600 dark-text-gray-600">This Month</div>
                                            </div>
                                            <div class="w-px h-12 border border-end border-dashed border-gray-300 dark-border-dark-5 mx-4 mx-xl-5"></div>
                                            <div>
                                                <div class="text-gray-600 dark-text-gray-600 fs-lg fs-xl-xl fw-medium">$10,000</div>
                                                <div class="mt-0.5 text-gray-600 dark-text-gray-600">Last Month</div>
                                            </div>
                                        </div>
                                        <div class="dropdown ms-xl-auto mt-5 mt-xl-0">
                                            <button class="dropdown-toggle btn btn-outline-secondary fw-normal" aria-expanded="false" data-bs-toggle="dropdown"> Filter by Category <i data-feather="chevron-down" class="w-4 h-4 ms-2"></i> </button>
                            ...
                            <div class="g-col-12 g-col-sm-6 g-col-lg-3 mt-8">
                                <div class="intro-y d-flex align-items-center h-10">
                                    ...
                                    <a href="index.html" class="ms-auto text-theme-1 dark-text-theme-10 truncate">Show More</a> 
                                </div>
                            ...
                            <div class="g-col-12 g-col-xl-8 mt-6">
                                <div class="intro-y d-block d-sm-flex align-items-center h-10">
                                    ...
                                    <div class="ms-sm-auto mt-3 mt-sm-0 position-relative text-gray-700 dark-text-gray-300">
                                        <i data-feather="map-pin" class="w-4 h-4 z-10 position-absolute my-auto top-0 bottom-0 ms-3 start-0"></i> 
                                        <input type="text" class="form-control w-sm-40 box border-white dark-border-dark-3 ps-10" placeholder="Filter by city">
                                    </div>
                                </div>
                                <div class="intro-y box p-5 mt-12 mt-sm-5">
                                    <div>250 Official stores in 21 countries, click the marker to see location details.</div>
                                    <div class="report-maps mt-5 bg-gray-200 rounded-3" data-center="-6.2425342, 106.8626478" data-sources="/dist/json/location.json"></div>
                                </div>
                            </div>
                            <!-- END: Official Store -->
                            ...
                            <div class="g-col-12 g-col-xl-4 mt-6">
                                ...
                                <div class="mt-5">
                                    <div class="intro-y">
                                        <div class="box px-4 py-4 mb-3 d-flex align-items-center zoom-in">
                                            <div class="w-10 h-10 flex-none image-fit rounded-2 overflow-hidden">
                                                <img alt="Rubick Bootstrap HTML Admin Template" src="{{ asset('backend/dist/images/profile-8.jpg') }}">
                                            </div>
                                            <div class="ms-4 me-auto">
                                                <div class="fw-medium">Keanu Reeves</div>
                                                <div class="text-gray-600 fs-xs mt-0.5">16 July 2021</div>
                                            </div>
                                            <div class="py-1 px-2 rounded-pill fs-xs bg-theme-9 text-white cursor-pointer fw-medium">137 Sales</div>
                                        </div>
                                    </div>
                                    <div class="intro-y">
                                        <div class="box px-4 py-4 mb-3 d-flex align-items-center zoom-in">
                                            <div class="w-10 h-10 flex-none image-fit rounded-2 overflow-hidden">
                                                <img alt="Rubick Bootstrap HTML Admin Template" src=" {{ asset('backend/dist/images/profile-11.jpg') }}">
                                            </div>
                                            <div class="ms-4 me-auto">
                                    ...
                                    <div class="intro-y">
                                        <div class="box px-4 py-4 mb-3 d-flex align-items-center zoom-in">
                                            <div class="w-10 h-10 flex-none image-fit rounded-2 overflow-hidden">
                                                <img alt="Rubick Bootstrap HTML Admin Template" src=" {{ asset('backend/dist/images/profile-7.jpg') }}">
                                            </div>
                                            <div class="ms-4 me-auto">
                                    ...
                                    <div class="intro-y">
                                        <div class="box px-4 py-4 mb-3 d-flex align-items-center zoom-in">
                                            <div class="w-10 h-10 flex-none image-fit rounded-2 overflow-hidden">
                                                <img alt="Rubick Bootstrap HTML Admin Template" src="{{ asset('backend/dist/images/profile-4.jpg') }}">
                                            </div>
                                            <div class="ms-4 me-auto">
                                    ...
                                    <a href="index.html" class="intro-y w-full d-block text-center rounded-2 py-4 border border-dotted border-theme-15 dark-border-dark-5 text-theme-16 dark-text-gray-600">View More</a> 
                                </div>
                            </div>
                                    ...
                                    <div class="box p-5 zoom-in">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-none ms-auto position-relative">
                                                ...
                                                <div class="fw-medium position-absolute w-full h-full d-flex align-items-center justify-content-center top-0 start-0">20%</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="g-col-12 g-col-sm-6 g-col-xxl-3 intro-y">
                                    <div class="box p-5 zoom-in">
                                        <div class="d-flex">
                                            ...
                                            <div class="py-1 px-2 d-flex align-items-center rounded-pill fs-xs bg-gray-200 dark-bg-dark-5 text-gray-600 dark-text-gray-300 cursor-pointer ms-auto truncate">320 Followers</div>
                                        </div>
                                        <div class="mt-4">
                                    ...
                                    <div class="box p-5 zoom-in">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-none ms-auto position-relative">
                                                ...
                                                <div class="fw-medium position-absolute w-full h-full d-flex align-items-center justify-content-center top-0 start-0">45%</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="g-col-12 g-col-sm-6 g-col-xxl-3 intro-y">
                                    <div class="box p-5 zoom-in">
                                        <div class="d-flex">
                                            ...
                                            <div class="py-1 px-2 d-flex align-items-center rounded-pill fs-xs bg-gray-200 dark-bg-dark-5 text-gray-600 dark-text-gray-300 cursor-pointer ms-auto truncate">180 Campaign</div>
                                        </div>
                                        <div class="mt-4">
                                            <canvas class="simple-line-chart-1 ms-n1" height="60"></canvas>
                                        </div>
                            ...
                            <div class="g-col-12 mt-6">
                                <div class="intro-y d-block d-sm-flex align-items-center h-10">
                                    ...
                                    <div class="d-flex align-items-center ms-sm-auto mt-3 mt-sm-0">
                                        <button class="btn box d-flex align-items-center text-gray-700 dark-text-gray-300"> <i data-feather="file-text" class="d-none d-sm-block w-4 h-4 me-2"></i> Export to Excel </button>
                                        <button class="ms-3 btn box d-flex align-items-center text-gray-700 dark-text-gray-300"> <i data-feather="file-text" class="d-none d-sm-block w-4 h-4 me-2"></i> Export to PDF </button>
                                    </div>
                                </div>
                                        ...
                                        <tbody>
                                            <tr class="intro-x">
                                                <td class="w-40">
                                                    <div class="d-flex">
                                                        <div class="w-10 h-10 image-fit zoom-in">
                                                            <img alt="Rubick Bootstrap HTML Admin Template" class="tooltip rounded-circle" src="{{ asset('backend/dist/images/preview-8.jpg') }}" title="Uploaded at 16 July 2021">
                                                        </div>
                                                        <div class="w-10 h-10 image-fit zoom-in ms-n5">
                                                            <img alt="Rubick Bootstrap HTML Admin Template" class="tooltip rounded-circle" src="{{ asset('backend/dist/images/preview-3.jpg') }}" title="Uploaded at 14 September 2021">
                                                        </div>
                                                        <div class="w-10 h-10 image-fit zoom-in ms-n5">
                                                            <img alt="Rubick Bootstrap HTML Admin Template" class="tooltip rounded-circle" src="{{ asset('backend/dist/images/preview-14.jpg ') }}" title="Uploaded at 7 August 2020">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <a href="index.html" class="fw-medium text-nowrap">Sony Master Series A9G</a> 
                                                ...
                                                <td class="table-report__action w-56">
                                                    <div class="d-flex justify-content-center align-items-center">
                                                        <a class="d-flex align-items-center me-3" href="index.html"> <i data-feather="check-square" class="w-4 h-4 me-1"></i> Edit </a>
                                                        <a class="d-flex align-items-center text-theme-6" href="index.html"> <i data-feather="trash-2" class="w-4 h-4 me-1"></i> Delete </a>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr class="intro-x">
                                                <td class="w-40">
                                                    <div class="d-flex">
                                                        <div class="w-10 h-10 image-fit zoom-in">
                                                            <img alt="Rubick Bootstrap HTML Admin Template" class="tooltip rounded-circle" src="{{ asset('backend/dist/images/preview-2.jpg ') }}" title="Uploaded at 15 January 2021">
                                                        </div>
                                                        <div class="w-10 h-10 image-fit zoom-in ms-n5">
                                                            <img alt="Rubick Bootstrap HTML Admin Template" class="tooltip rounded-circle" src="{{ asset('backend/dist/images/preview-5.jpg ') }}" title="Uploaded at 16 January 2021">
                                                        </div>
                                                        <div class="w-10 h-10 image-fit zoom-in ms-n5">
                                                            <img alt="Rubick Bootstrap HTML Admin Template" class="tooltip rounded-circle" src="'{{ asset('backend/dist/images/preview-9.jpg ') }}" title="Uploaded at 22 July 2021">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr class="intro-x">
                                                <td class="w-40">
                                                    <div class="d-flex">
                                                        <div class="w-10 h-10 image-fit zoom-in">
                                                            <img alt="Rubick Bootstrap HTML Admin Template" class="tooltip rounded-circle" src="{{ asset( 'backend/dist/images/preview-13.jpg') }}" title="Uploaded at 7 July 2022">
                                                        </div>
                                                        <div class="w-10 h-10 image-fit zoom-in ms-n5">
                                                            <img alt="Rubick Bootstrap HTML Admin Template" class="tooltip rounded-circle" src="{{ asset( 'backend/dist/images/preview-6.jpg') }}" title="Uploaded at 7 December 2021">
                                                        </div>
                                                        <div class="w-10 h-10 image-fit zoom-in ms-n5">
                                                            <img alt="Rubick Bootstrap HTML Admin Template" class="tooltip rounded-circle" src="{{ asset( 'backend/dist/images/preview-1.jpg ') }}" title="Uploaded at 13 February 2021">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr class="intro-x">
                                                <td class="w-40">
                                                    <div class="d-flex">
                                                        <div class="w-10 h-10 image-fit zoom-in">
                                                            <img alt="Rubick Bootstrap HTML Admin Template" class="tooltip rounded-circle" src="{{ asset('backend/dist/images/preview-3.jpg') }}" title="Uploaded at 19 September 2020">
                                                        </div>
                                                        <div class="w-10 h-10 image-fit zoom-in ms-n5">
                                                            <img alt="Rubick Bootstrap HTML Admin Template" class="tooltip rounded-circle" src="{{ asset('backend/dist/images/preview-3.jpg') }}" title="Uploaded at 21 May 2021">
                                                        </div>
                                                        <div class="w-10 h-10 image-fit zoom-in ms-n5">
                                                            <img alt="Rubick Bootstrap HTML Admin Template" class="tooltip rounded-circle" src="{{ asset('backend/dist/images/preview-1.jpg') }}" title="Uploaded at 30 December 2021">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                ...
                                <div class="intro-y d-flex flex-wrap flex-sm-row flex-sm-nowrap align-items-center mt-3">
                                    <nav class="w-full w-sm-auto me-sm-auto">
                                        <ul class="pagination">
                                            <li class="page-item">
                                                <a class="page-link" href="index.html#"> <i class="w-4 h-4" data-feather="chevrons-left"></i> </a>
                                            </li>
                                            <li class="page-item">
                                                <a class="page-link" href="index.html#"> <i class="w-4 h-4" data-feather="chevron-left"></i> </a>
                                            </li>
                                            <li class="page-item"> <a class="page-link" href="index.html#">...</a> </li>
                                            <li class="page-item"> <a class="page-link" href="index.html#">1</a> </li>
                                            <li class="page-item active"> <a class="page-link" href="index.html#">2</a> </li>
                                            <li class="page-item"> <a class="page-link" href="index.html#">3</a> </li>
                                            <li class="page-item"> <a class="page-link" href="index.html#">...</a> </li>
                                            <li class="page-item">
                                                <a class="page-link" href="index.html#"> <i class="w-4 h-4" data-feather="chevron-right"></i> </a>
                                            </li>
                                            <li class="page-item">
                                                <a class="page-link" href="index.html#"> <i class="w-4 h-4" data-feather="chevrons-right"></i> </a>
                                            </li>
                                        </ul>
                                    </nav>
                    ...
                    <div class="g-col-12 g-col-xxl-3">
                        <div class="border-start-xxl border-theme-5 dark-border-dark-3 mb-n10 pb-10">
                            <div class="ps-xxl-6 grid grid-cols-12 gap-6">
                                ...
                                <div class="g-col-12 g-col-md-6 g-col-xl-4 g-col-xxl-12 mt-3 mt-xxl-8">
                                    ...
                                    <div class="mt-5">
                                        ...
                                        <div class="intro-x">
                                            <div class="box px-5 py-3 mb-3 d-flex align-items-center zoom-in">
                                                <div class="w-10 h-10 flex-none image-fit rounded-circle overflow-hidden">
                                                    <img alt="Rubick Bootstrap HTML Admin Template" src=" {{ asset( 'backend/dist/images/profile-15.jpg')}}">
                                                </div>
                                                <div class="ms-4 me-auto">
                                    ...
                                    <div class="report-timeline mt-5 position-relative">
                                        <div class="intro-x position-relative d-flex align-items-center mb-3">
                                            <div class="report-timeline__image">
                                                <div class="w-10 h-10 flex-none image-fit rounded-circle overflow-hidden">
                                                    <img alt="Rubick Bootstrap HTML Admin Template" src=" {{ asset('backend/dist/images/profile-14.jpg') }}">
                                                </div>
                                            </div>
                                        ...
                                        <div class="intro-x position-relative d-flex align-items-center mb-3">
                                            <div class="report-timeline__image">
                                                <div class="w-10 h-10 flex-none image-fit rounded-circle overflow-hidden">
                                                    <img alt="Rubick Bootstrap HTML Admin Template" src="{{ asset ('backend/dist/images/profile-6.jpg') }}">
                                                </div>
                                            </div>
                                            <div class="box px-5 py-3 ms-4 flex-1 zoom-in">
                                                <div class="d-flex align-items-center">
                                                ...
                                                <div class="text-gray-600">
                                                    ...
                                                    <div class="d-flex mt-2">
                                                        <div class="tooltip w-8 h-8 image-fit me-1 zoom-in" title="Sony Master Series A9G">
                                                            <img alt="Rubick Bootstrap HTML Admin Template" class="rounded-2 border border-white dark-border-dark-3" src="{{ asset('backend/dist/images/preview-2.jpg') }}">
                                                        </div>
                                                        <div class="tooltip w-8 h-8 image-fit me-1 zoom-in" title="Dell XPS 13">
                                                            <img alt="Rubick Bootstrap HTML Admin Template" class="rounded-2 border border-white dark-border-dark-3" src="{{ asset('backend/dist/images/preview-10.jpg ') }}">
                                                        </div>
                                                        <div class="tooltip w-8 h-8 image-fit me-1 zoom-in" title="Nikon Z6">
                                                            <img alt="Rubick Bootstrap HTML Admin Template" class="rounded-2 border border-white dark-border-dark-3" src="{{ asset('backend/dist/images/preview-9.jpg') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="intro-x position-relative d-flex align-items-center mb-3">
                                            ...
                                            <div class="box px-5 py-3 ms-4 flex-1 zoom-in">
                                                ...
                                                <div class="text-gray-600 mt-1">Has changed <a class="text-theme-1 dark-text-theme-10" href="index.html">Samsung Q90 QLED TV</a> price and description</div>
                                            </div>
                                        </div>
                                        <div class="intro-x position-relative d-flex align-items-center mb-3">
                                            <div class="report-timeline__image">
                                            ...
                                            <div class="box px-5 py-3 ms-4 flex-1 zoom-in">
                                                ...
                                                <div class="text-gray-600 mt-1">Has changed <a class="text-theme-1 dark-text-theme-10" href="index.html">Nike Tanjun</a> description</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="g-col-12 g-col-md-6 g-col-xl-12 g-start-xl-1 g-row-start-xl-1 g-start-xxl-auto g-row-start-xxl-auto mt-3">
                                    <div class="intro-x d-flex align-items-center h-10">
                                        <h2 class="fs-lg fw-medium truncate me-auto">
                                            Important Notes
                                        </h2>
                                        <button data-carousel="important-notes" data-target="prev" class="tiny-slider-navigator btn px-2 border-gray-400 dark-border-dark-3 text-gray-700 dark-text-gray-300 me-2"> <i data-feather="chevron-left" class="w-4 h-4"></i> </button>
                                        <button data-carousel="important-notes" data-target="next" class="tiny-slider-navigator btn px-2 border-gray-400 dark-border-dark-3 text-gray-700 dark-text-gray-300 me-2"> <i data-feather="chevron-right" class="w-4 h-4"></i> </button>
                                    </div>
                                    <div class="mt-5 intro-x">
                                        <div class="box zoom-in">
                                            <div class="tiny-slider" id="important-notes">
                                                <div class="p-5">
                                                    <div class="fs-base fw-medium truncate">Lorem Ipsum is simply dummy text</div>
                                                    ...
                                                    <div class="fw-medium d-flex mt-5">
                                                        ...
                                                        <button type="button" class="btn btn-outline-secondary py-1 px-2 ms-auto">Dismiss</button>
                                                    </div>
                                                </div>
                                                <div class="p-5">
                                                    <div class="fs-base fw-medium truncate">Lorem Ipsum is simply dummy text</div>
                                ...
                                <div class="g-col-12 g-col-md-6 g-col-xl-4 g-col-xxl-12 g-start-xl-1 g-row-start-xl-2 g-start-xxl-auto g-row-start-xxl-auto mt-3">
                                    <div class="intro-x d-flex align-items-center h-10">
                                        ...
                                        <a href="index.html" class="ms-auto text-theme-26 dark-text-gray-400 truncate d-flex align-items-center"> <i data-feather="plus" class="w-4 h-4 me-1"></i> Add New Schedules </a>
                                    </div>
                                    <div class="mt-5">
