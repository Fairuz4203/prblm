                            ...
                            <div class="col-md-8">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="welcome_text" name="welcome_text" 
                                                   value="{{ old('welcome_text', $banner->welcome_text) }}" placeholder="e.g., Welcome to shopery">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="main_title" name="main_title" 
                                                   value="{{ old('main_title', $banner->main_title) }}" required placeholder="e.g., Fresh & Healthy Organic Food">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="subtitle" name="subtitle" 
                                                   value="{{ old('subtitle', $banner->subtitle) }}" placeholder="e.g., Sale up to 30% OFF">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="description" name="description" rows="3" 
                                              placeholder="e.g., Free shipping on all your order. we deliver, you enjoy">{{ old('description', $banner->description) }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="url" class="form-control" id="button_link" name="button_link" 
                                           value="{{ old('button_link', $banner->button_link) }}" placeholder="e.g., /shop">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            @if($banner->image)
                                                ...
                                                <p class="mt-2 text-muted">Current banner image</p>
                                            @else
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div id="image-preview" class="text-center">
                                                <p class="text-muted">Select a new image to see preview</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    $(document).ready(function() {
        ...
        $('#image').change(function() {
            ...
            if (file) {
                ...
                $('#image-preview').html('<p class="text-muted">Select a new image to see preview</p>');
            }
        });
    });
</script>
