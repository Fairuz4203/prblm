            ...
            <div class="grid columns-2 gap-4">
                ...
                <div class="g-col-2 g-col-xl-1 d-none d-xl-flex flex-column min-vh-screen">
                    <a href="login-light-login.html" class="-intro-x d-flex align-items-center pt-5">
                        <img alt="logo" style="filter: grayscale(100%) invert(100%) brightness(200%)" class="w-100" src="{{ asset('frontend/images/Logo .png') }}">
                        <span class="text-white fs-lg ms-3">  </span>
                    </a>
                    <div class="my-auto">
                       
                        <div class="-intro-x text-white fw-medium fs-4xl lh-base mt-10">
                            <h3>  Welcome to <img alt="logo" class="w-100 align-middle" src="{{ asset('frontend/images/Logo .png') }}"></span></h3><br>
                ...
                <div class="g-col-2 g-col-xl-1 h-screen h-xl-auto d-flex py-5 py-xl-0 my-10 my-xl-0">
                    ...
                    <div class="my-auto mx-auto ms-xl-20 bg-white dark-bg-dark-1 bg-xl-transparent px-5 px-sm-8 py-8 p-xl-0 rounded-2 shadow-md shadow-xl-none w-full w-sm-3/4 w-lg-2/4 w-xl-auto">
                        ...
                        <div class="intro-x mt-8">
                            <input name="email" type="text" class="intro-x login__input form-control py-3 px-4 border-gray-300 d-block" placeholder="Email">
                            <input name="password" type="password" class="intro-x login__input form-control py-3 px-4 border-gray-300 d-block mt-4" placeholder="Password">
                        </div>
